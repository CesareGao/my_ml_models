class GradientDescent:
    def __init__(self, method="minibatch", learning_rate=0.001, max_iter=1000, cost_limit=0.00001, batch_size=None):
        ...
        if method == "minibatch":
            if batch_size:
                ...
                self.batch_size = 128
                print("WARNING! No batch size given. Use default size 32")
        if method == "batch":
